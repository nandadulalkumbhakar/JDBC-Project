...
class Operation1 {
    ...
    public static void menu()
    {
        ...
        System.out.println("5. create able");
    ...
    public static void createTable(Statement stmt) throws SQLException {
        String createTable="create table if not exists Employee ( st_id int auto_increment primary key,"+
                "name varchar(30),"
               // +"age int,"
                +"email varchar(50),"
                +"phoneNo varchar(10)"
